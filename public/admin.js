...
document.getElementById('exportEmployeesBtn').addEventListener('click', () => downloadProtectedFile('/api/export/employees', 'employees.json'));
document.getElementById('exportLogsBtn').addEventListener('click', () => downloadProtectedFile('/api/export/logs', 'logs.json'));
document.getElementById('exportSitesBtn').addEventListener('click', () => downloadProtectedFile('/api/export/sites', 'sites.json'));
document.getElementById('exportAllBtn').addEventListener('click', () => downloadProtectedFile('/api/export/all-data', 'clockflow-backup.json'));
